...
VL_ATTR_COLD void Vled_blink___024root__trace_const_0_sub_0(Vled_blink___024root* vlSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vled_blink___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    ...
    Vled_blink__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vled_blink___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vled_blink___024root__trace_const_0_sub_0(Vled_blink___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vled_blink__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vled_blink___024root__trace_const_0_sub_0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vled_blink___024root__trace_full_0_sub_0(Vled_blink___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelfRef.led_blink__DOT__counter),32);
}
