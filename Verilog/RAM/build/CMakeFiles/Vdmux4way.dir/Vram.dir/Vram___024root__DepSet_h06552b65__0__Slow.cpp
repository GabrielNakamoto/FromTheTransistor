...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vram___024root___eval_phase__stl(Vram___024root* vlSelf);
...
#endif
            VL_FATAL_MT("/home/raine/FromTheTransistor/Verilog/RAM/ram.v", 17, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vram___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD bool Vram___024root___eval_phase__stl(Vram___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vram__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vram___024root___eval_phase__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
